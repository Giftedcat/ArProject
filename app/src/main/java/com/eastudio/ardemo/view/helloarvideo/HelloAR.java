...
package com.eastudio.ardemo.view.helloarvideo;
...
public class HelloAR
{
    ...
    public HelloAR(ScanningListener listener)
    {
                ...
                if (status == TargetStatus.Tracked) {
                    ...
                    if (tracked_target == 0) {
                        if (video == null && video_renderers.size() > 0) {
                            ...
                            } else if (target_name.equals("xh") && video_renderers.get(1).texId() != 0) {
                                video = new ARVideo();
